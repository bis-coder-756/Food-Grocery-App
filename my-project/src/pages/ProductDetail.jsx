...
const ProductDetail = () => {
    ...
    //  USEEFFECT FOR RELATED PRODUCTS  ///
    useEffect(() => {
    ...
    // USE EFFECT FOR INDIVIDUAL PRODUCT  //
    useEffect(() => {
    ...
    return product && (
        <div className="mt-12">
            <p>
                ...
                <Link to="" className="text-primary"> {product.name}</Link>
            </p>
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                            ...
                            <img src={i < 4 ? assets.star_icon : assets.star_dull_icon} alt="rating" className='md:w-4 w-3.4' />
            ...
            <div className='flex flex-col mt-20 items-center'>
                <div className='flex flex-col items-center w-max'>
                    <p className='text-3xl font-medium text-uppercase'>Related Products</p>
