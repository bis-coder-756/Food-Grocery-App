...
const Cartpage = () => {
    const { products, currency, removefromcart, cartItems, getcartcount, updatecartitem,
        getcartamount, navigate, axios, user, setCartItems } = useAppContext();
    ...
    const placeorder = async () => {
        // we will add logic in this function when we will create our backend  //
        try {
            if (!selectedAddress) {
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                ...
                                <p onClick={() => navigate('/add-dddress')} className="text-primary text-center cursor-pointer p-2 hover:bg-primary/10">
                                    Add address
                                </p>
                            </div>
                        )}
